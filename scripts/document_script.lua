...
-- Changed: Removed centralized logging - each script handles its own logging
...
local function parseConfiguration()
    ...
    print("[" .. os.date("%H:%M:%S") .. "] " .. SCRIPT_NAME .. ": Config: " .. connectionCount .. " connections, " .. unfoldCount .. " unfolds")
    return true
end
...
function init()
    ...
    print("════════════════════════════════════════")
    print("═══ NEW SESSION " .. os.date("%Y-%m-%d %H:%M:%S") .. " ═══")
    print("════════════════════════════════════════")
    
    print("[" .. os.date("%H:%M:%S") .. "] " .. SCRIPT_NAME .. " v" .. VERSION .. " loaded")
    ...
    print("[" .. os.date("%H:%M:%S") .. "] " .. SCRIPT_NAME .. ": Ready")
    print("[" .. os.date("%H:%M:%S") .. "] " .. SCRIPT_NAME .. ": Automatic refresh scheduled...")
