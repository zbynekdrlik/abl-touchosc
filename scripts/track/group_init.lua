...
-- Version: 1.16.3
-- Changed: Use script variables instead of custom properties for better compatibility
                ...
                for i = 1, #arguments do
                    if arguments[i] and arguments[i].value then
                        ...
                        if trackNameValue == trackName then
                            ...
                            -- DON'T CHANGE TAG - keep it as trackGroup
...
function getTrackInfo()
    -- Return the script variables directly
    return trackNumber, trackType
end

-- Function to get instance (called by children for connection lookup)
